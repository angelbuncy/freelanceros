  ...
  return (
    <div className={cn("relative flex items-center justify-center", wrapperClassName)}>
      ...
      <div id="poda" className="relative flex items-center justify-center group w-full">
        ...
        {/* Layer 1 */}
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[414px] rounded-xl blur-[3px] 
        ...
        {/* Layer 2 */}
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[412px] rounded-xl blur-[3px] 
        ...
        {/* Layer 5 */}
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[407px] rounded-lg blur-[2px] 
        ...
        {/* Layer 6 */}
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[403px] rounded-xl blur-[0.5px] 
        ...
        <div id="main" className="relative group w-full">
          <input 
            ...
            name="text" 
            autoComplete="off"
            className={cn("bg-[#010201] border-none w-full sm:w-[401px] h-[56px] rounded-lg text-white px-[59px] text-[15px] focus:outline-none placeholder-gray-400", className)} 
            {...inputProps} 
          />
          ...
          <div id="pink-mask" className="pointer-events-none w-[30px] h-[20px] absolute bg-[#cf30aa] top-[20px] left-[5px] blur-2xl opacity-80 transition-all duration-2000 group-hover:opacity-0"></div>
